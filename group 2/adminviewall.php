...
<?php for ($i = 0; $i < mysqli_num_rows($result1); $i++) { ?>
    <div class="row">
        ...
        <?php while ($query_row1 = mysqli_fetch_assoc($result1)) { ?>
            <div class="col-md-3">
                <a href="adminshowcasect.php?bookisbn=<?php echo $query_row1['book_isbn']; ?>">
...
<?php for ($i = 0; $i < mysqli_num_rows($result2); $i++) { ?>
    <div class="row">
        <?php while ($query_row2 = mysqli_fetch_assoc($result2)) { ?>
            <div class="col-md-3">
                <a href="adminshowcasecs.php?bookisbn=<?php echo $query_row2['book_isbn']; ?>">
...
<?php for ($i = 0; $i < mysqli_num_rows($result3); $i++) { ?>
    <div class="row">
        <?php while ($query_row3 = mysqli_fetch_assoc($result3)) { ?>
            <div class="col-md-3">
                <a href="adminshowcasecis.php?bookisbn=<?php echo $query_row3['book_isbn']; ?>">
...
<?php for ($i = 0; $i < mysqli_num_rows($result4); $i++) { ?>
    <div class="row">
        <?php while ($query_row4 = mysqli_fetch_assoc($result4)) { ?>
            <div class="col-md-3">
                <a href="adminshowcasese.php?bookisbn=<?php echo $query_row4['book_isbn']; ?>">
